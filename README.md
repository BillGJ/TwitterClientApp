# Project 3 - *Twitter with fragments App*

**Twitter with fragments App** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
## License
    ...
    Copyright [2017] [Ebillson GRAND JEAN]
